...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>CCTV Security Sales and Services</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <hr>
<img class="img-responsive" src="${pageContext.request.contextPath}/images/css/CCTV_Industry.jpeg" alt="CCTV Industry use">
               <br/><p>CCTV Cameras are becoming an integral part of security in home and commercial places.</p>

<p>CCTC (Closed Circuit Camera) is a term widely used for surveillance and providing security. CCTC system allows you to monitor different places from a single stand point. The video captures from the video recorder cameras is transmitted to a station where it can be live seen on a monitor. This helps in crime prevention and investigation and monitoring progress at a work station.</p>

<ul>
                <li>Use</li>
</ul>
<img class="img-responsive" src="${pageContext.request.contextPath}/images/css/CCTV_Usage.png" alt="CCTV Usages">
<br/>
<p>CCTC cameras are mostly used in Banks, Jewellery shops, Restaurants, Retail Shops, Traffic Monitoring, Industry, Schools etc.</p>

<ul>
                <li>Storage</li>
</ul>

<p>Most CCTV camera stores the recording and images to a Digital Video Recorder (DVR). From here data can be retrieved and viewed. This data can be stored for some time and then can be archived or deleted permanently after some time. The size of the data is dependent upon the quality of data being stored, which can be configured easily.</p>

<ul>
                <li>Installation</li>
</ul>

<p>The Installation of cctv camera is a straight forward activity once the number of locations, time for which the data needs to be stored, quality of video is decided. Our service executive will provide you the best suited option based upon your business and requirements.</p>
